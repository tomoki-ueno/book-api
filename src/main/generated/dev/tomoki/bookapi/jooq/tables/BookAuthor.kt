...
import dev.tomoki.bookapi.jooq.keys.BOOK_AUTHOR_PKEY
...
open class BookAuthor(
    ...
    override fun getReferences(): List<ForeignKey<BookAuthorRecord, *>> = listOf(BOOK_AUTHOR__FK_BOOK_AUTHOR_AUTHOR, BOOK_AUTHOR__FK_BOOK_AUTHOR_BOOK)
    ...
    fun author(): AuthorPath {
        if (!this::_author.isInitialized)
            _author = AuthorPath(this, BOOK_AUTHOR__FK_BOOK_AUTHOR_AUTHOR, null)
    ...
    fun book(): BookPath {
        if (!this::_book.isInitialized)
            _book = BookPath(this, BOOK_AUTHOR__FK_BOOK_AUTHOR_BOOK, null)
