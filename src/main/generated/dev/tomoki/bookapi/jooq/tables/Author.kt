...
import dev.tomoki.bookapi.jooq.keys.AUTHOR_PKEY
import dev.tomoki.bookapi.jooq.keys.BOOK_AUTHOR__FK_BOOK_AUTHOR_AUTHOR
import dev.tomoki.bookapi.jooq.tables.Book.BookPath
...
open class Author(
     ...
     */
    val AUTHOR_ID: TableField<AuthorRecord, Long?> = createField(DSL.name("author_id"), SQLDataType.BIGINT.nullable(false).identity(true), this, "")

    /**
     * The column <code>public.author.name</code>.
     */
    val NAME: TableField<AuthorRecord, String?> = createField(DSL.name("name"), SQLDataType.VARCHAR(255).nullable(false), this, "")

    /**
     * The column <code>public.author.birth_date</code>.
     */
    val BIRTH_DATE: TableField<AuthorRecord, LocalDate?> = createField(DSL.name("birth_date"), SQLDataType.LOCALDATE.nullable(false), this, "")
    ...
    fun bookAuthor(): BookAuthorPath {
        if (!this::_bookAuthor.isInitialized)
            _bookAuthor = BookAuthorPath(this, null, BOOK_AUTHOR__FK_BOOK_AUTHOR_AUTHOR.inverseKey)
